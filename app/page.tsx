...
export default function MyForm() {
  ...
  const handleAddRecipient = async () => {
    ...
    if (!isValid) {
      // If the form is invalid, the error messages will be shown by react-hook-form
      return;
    }
    
    // Get the form values directly rather than from the handleSubmit method
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 pt-5 space-y-10">
